...
public class AParameterDaoImpl implements IParameterDao {
	...
	public boolean save(Parameter parameter) {
		...
		String returnId = (String) session.save(parameter);
	...
	public Parameter getById(String id) {
		Session session = sessionFactory.openSession();
		Parameter dto = (Parameter)session.get(Parameter.class, id);
		session.close();
		return dto;
	}
